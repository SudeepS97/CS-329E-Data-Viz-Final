# Change "Density", all __1_s, and edit tiles below:
tabItem(tabName = "barChart1",
        tabsetPanel( 
          ...
          tabPanel("Plot Title",
              textInput("title__1_", "Title 1", "Percent Change in Abortions Rate"),
              numericInput("titleFont__1_", "Title Font", 10)), 
          tabPanel("Plot Legend",
              textInput("legendTitle__1_", "Legend Title", "Make"),
          ...
          tabPanel("Axis Labels",
              textInput("xLabel__1_", "x-Axis Label", "Year"),
              textInput("yLabel__1_", "y-Axis Label 1", "Percent Change Abortions"),
        ...
        plotlyOutput("Density__1_", height=800)
)
